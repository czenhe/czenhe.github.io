 ...
 */
export const isEmptyParagraph = (block: any) =>
 ...
 */
export const getSupportedBlocks = (result: any) =>
  result.filter((block: any) => block.type !== 'unsupported');
 ...
 */
export const getNonEmptyParagraphs = (result: any) =>
  result.filter((block: any) => block.type !== 'paragraph' || !isEmptyParagraph(block));
 ...
 */
export const getAsSensiblyStructuredBlocks = (result: any) => {
  const ret = [result[0]];
